...
live in `gfx/`, test-only reference screenshots live under `crates/vibe-emu-core/tests/reference_screenshots/`, and a patched
copy of `libmobile` is vendored under `vendor/`.
