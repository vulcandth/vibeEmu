...
| --- | --- | --- | --- | --- | --- | --- |
| ROM Test Suites | 2021 | 1857 | 0 | 0 | 3878 | 52.1% |
| Integration Tests | 171 | 2 | 0 | 0 | 173 | 98.8% |
| Unit Tests | 99 | 0 | 0 | 0 | 99 | 100.0% |
| Doc Tests | 16 | 0 | 0 | 0 | 16 | 100.0% |
| **Overall** | 2307 | 1859 | 0 | 0 | 4166 | 55.4% |

## Detailed Results

### ROM Test Suites

#### age (24/119 passing, 20.2%)
...
| `halt/halt-m0-interrupt-dmgC-cgbBCE.gb::cgbB` | ❌ Fail |
| `halt/halt-m0-interrupt-dmgC-cgbBCE.gb::cgbC` | ❌ Fail |
| `halt/halt-m0-interrupt-dmgC-cgbBCE.gb::cgbE` | ❌ Fail |
| `halt/halt-m0-interrupt-dmgC-cgbBCE.gb::dmgC` | ❌ Fail |
| `lcd-align-ly/lcd-align-ly-cgbBC.gb::cgbB` | ❌ Fail |
| `lcd-align-ly/lcd-align-ly-cgbBC.gb::cgbC` | ❌ Fail |
| `lcd-align-ly/lcd-align-ly-cgbE.gb::cgbE` | ❌ Fail |
...
| `m3-bg-lcdc/m3-bg-lcdc-ds.gb::cgbB` | ❌ Fail |
| `m3-bg-lcdc/m3-bg-lcdc-ds.gb::cgbC` | ❌ Fail |
| `m3-bg-lcdc/m3-bg-lcdc-ds.gb::cgbE` | ❌ Fail |
| `m3-bg-lcdc/m3-bg-lcdc-nocgb.gb::ncmB` | ❌ Fail |
| `m3-bg-lcdc/m3-bg-lcdc-nocgb.gb::ncmC` | ❌ Fail |
| `m3-bg-lcdc/m3-bg-lcdc-nocgb.gb::ncmE` | ❌ Fail |
| `m3-bg-lcdc/m3-bg-lcdc.gb::cgbB` | ❌ Fail |
| `m3-bg-lcdc/m3-bg-lcdc.gb::cgbC` | ❌ Fail |
| `m3-bg-lcdc/m3-bg-lcdc.gb::cgbE` | ❌ Fail |
| `m3-bg-lcdc/m3-bg-lcdc.gb::dmgC` | ❌ Fail |
| `m3-bg-scx/m3-bg-scx-ds.gb::cgbB` | ❌ Fail |
| `m3-bg-scx/m3-bg-scx-ds.gb::cgbC` | ❌ Fail |
| `m3-bg-scx/m3-bg-scx-ds.gb::cgbE` | ❌ Fail |
| `m3-bg-scx/m3-bg-scx-nocgb.gb::ncmB` | ❌ Fail |
| `m3-bg-scx/m3-bg-scx-nocgb.gb::ncmC` | ❌ Fail |
| `m3-bg-scx/m3-bg-scx-nocgb.gb::ncmE` | ❌ Fail |
| `m3-bg-scx/m3-bg-scx.gb::cgbB` | ❌ Fail |
| `m3-bg-scx/m3-bg-scx.gb::cgbC` | ❌ Fail |
| `m3-bg-scx/m3-bg-scx.gb::cgbE` | ❌ Fail |
| `m3-bg-scx/m3-bg-scx.gb::dmgC` | ❌ Fail |
| `oam/oam-read-cgbE.gb::cgbE` | ❌ Fail |
| `oam/oam-read-dmgC-cgbBC.gb::cgbB` | ❌ Fail |
| `oam/oam-read-dmgC-cgbBC.gb::cgbC` | ❌ Fail |
| `oam/oam-read-dmgC-cgbBC.gb::dmgC` | ❌ Fail |
| `oam/oam-read-ncmBC.gb::ncmB` | ❌ Fail |
| `oam/oam-read-ncmBC.gb::ncmC` | ❌ Fail |
| `oam/oam-read-ncmE.gb::ncmE` | ❌ Fail |
| `oam/oam-write-cgbBCE.gb::cgbB` | ❌ Fail |
| `oam/oam-write-cgbBCE.gb::cgbC` | ❌ Fail |
| `oam/oam-write-cgbBCE.gb::cgbE` | ❌ Fail |
| `oam/oam-write-dmgC.gb::dmgC` | ❌ Fail |
| `oam/oam-write-ncmBCE.gb::ncmB` | ❌ Fail |
| `oam/oam-write-ncmBCE.gb::ncmC` | ❌ Fail |
| `oam/oam-write-ncmBCE.gb::ncmE` | ❌ Fail |
| `speed-switch/caution/spsw-interrupts-cgbBC.gb::cgbB` | ❌ Fail |
| `speed-switch/caution/spsw-interrupts-cgbBC.gb::cgbC` | ❌ Fail |
| `speed-switch/caution/spsw-interrupts-cgbE.gb::cgbE` | ❌ Fail |
| `speed-switch/spsw-ch2-lc-delay-cgbBCE.gb::cgbB` | ❌ Fail |
| `speed-switch/spsw-ch2-lc-delay-cgbBCE.gb::cgbC` | ❌ Fail |
| `speed-switch/spsw-ch2-lc-delay-cgbBCE.gb::cgbE` | ❌ Fail |
| `speed-switch/spsw-mode0-cgbBCE.gb::cgbB` | ❌ Fail |
| `speed-switch/spsw-mode0-cgbBCE.gb::cgbC` | ❌ Fail |
| `speed-switch/spsw-mode0-cgbBCE.gb::cgbE` | ❌ Fail |
| `stat-interrupt/stat-int-dmgC-cgbBCE.gb::cgbB` | ❌ Fail |
| `stat-interrupt/stat-int-dmgC-cgbBCE.gb::cgbC` | ❌ Fail |
| `stat-interrupt/stat-int-dmgC-cgbBCE.gb::cgbE` | ❌ Fail |
...
| `stat-mode-sprites/stat-mode-sprites-dmgC-cgbBCE.gb::cgbB` | ❌ Fail |
| `stat-mode-sprites/stat-mode-sprites-dmgC-cgbBCE.gb::cgbC` | ❌ Fail |
| `stat-mode-sprites/stat-mode-sprites-dmgC-cgbBCE.gb::cgbE` | ❌ Fail |
| `stat-mode-sprites/stat-mode-sprites-dmgC-cgbBCE.gb::dmgC` | ❌ Fail |
| `stat-mode-sprites/stat-mode-sprites-ds-cgbBCE.gb::cgbB` | ❌ Fail |
| `stat-mode-sprites/stat-mode-sprites-ds-cgbBCE.gb::cgbC` | ❌ Fail |
| `stat-mode-sprites/stat-mode-sprites-ds-cgbBCE.gb::cgbE` | ❌ Fail |
| `stat-mode-window/stat-mode-window-cgbBCE.gb::cgbB` | ❌ Fail |
| `stat-mode-window/stat-mode-window-cgbBCE.gb::cgbC` | ❌ Fail |
| `stat-mode-window/stat-mode-window-cgbBCE.gb::cgbE` | ❌ Fail |
| `stat-mode-window/stat-mode-window-dmgC.gb::dmgC` | ❌ Fail |
| `stat-mode-window/stat-mode-window-ds-cgbBCE.gb::cgbB` | ❌ Fail |
| `stat-mode-window/stat-mode-window-ds-cgbBCE.gb::cgbC` | ❌ Fail |
| `stat-mode-window/stat-mode-window-ds-cgbBCE.gb::cgbE` | ❌ Fail |
...
| `stat-mode/stat-mode-cgbE.gb::cgbE` | ❌ Fail |
| `stat-mode/stat-mode-dmgC-cgbBC.gb::cgbB` | ❌ Fail |
| `stat-mode/stat-mode-dmgC-cgbBC.gb::cgbC` | ❌ Fail |
| `stat-mode/stat-mode-dmgC-cgbBC.gb::dmgC` | ❌ Fail |
| `stat-mode/stat-mode-ds-cgbBCE.gb::cgbB` | ❌ Fail |
| `stat-mode/stat-mode-ds-cgbBCE.gb::cgbC` | ❌ Fail |
| `stat-mode/stat-mode-ds-cgbBCE.gb::cgbE` | ❌ Fail |
| `stat-mode/stat-mode-ncmBC.gb::ncmB` | ❌ Fail |
| `stat-mode/stat-mode-ncmBC.gb::ncmC` | ❌ Fail |
| `stat-mode/stat-mode-ncmE.gb::ncmE` | ❌ Fail |
| `vram/vram-read-cgbBCE.gb::cgbB` | ❌ Fail |
| `vram/vram-read-cgbBCE.gb::cgbC` | ❌ Fail |
| `vram/vram-read-cgbBCE.gb::cgbE` | ❌ Fail |
| `vram/vram-read-dmgC.gb::dmgC` | ❌ Fail |
| `vram/vram-read-ncmBCE.gb::ncmB` | ❌ Fail |
| `vram/vram-read-ncmBCE.gb::ncmC` | ❌ Fail |
| `vram/vram-read-ncmBCE.gb::ncmE` | ❌ Fail |
...
#### gambatte (1692/3429 passing, 49.3%)
...
| `irq_precedence/late_m0irq_vs_tima_scx3_halt_1_dmg08_cgb04c_out4.gbc` | ✅ Pass |
...
| `m1/ly143_late_m2enable_2_dmg08_out3_cgb04c_out1.gbc` | ✅ Pass |
...
| `m2enable/lyc1_m2irq_late_lyc255_ds_2_cgb04c_out0.gbc` | ✅ Pass |
...
| `speedchange/speedchange2_ly44_m3_m3stat_scx3_2_cgb04c_outC0.gbc` | ✅ Pass |
...
| `speedchange/speedchange2_ly44_m3_nopx2_m3stat_scx3_2_cgb04c_outC0.gbc` | ✅ Pass |
...
| `speedchange/speedchange2_nop_ly44_m3_m3stat_scx3_2_cgb04c_outC0.gbc` | ✅ Pass |
...
| `enable_display/frame0_m1stat_ds_2_cgb04c_out81.gbc` | ❌ Fail |
...
| `enable_display/frame1_m1stat_ds_2_cgb04c_out81.gbc` | ❌ Fail |
...
| `lcd_offset/offset1_lyc99int_m2stat_count_2_cgb04c_out90.gbc` | ❌ Fail |
...
| `m2enable/lyc1_late_m2enable_lycdisable_ds_1_cgb04c_out2.gbc` | ❌ Fail |
...
| `m2enable/lyc1_m2irq_late_lycdisable_ds_1_cgb04c_out2.gbc` | ❌ Fail |
